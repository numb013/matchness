...
/*
 プロトコル
 */
protocol MultipleModelDelegate {
...
/*
 プロトコル判定用
 */
enum MultipleModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}

class MultipleModel: NSObject {
    //プロトコル
    var delegate: MultipleModelDelegate?;

...
/*
 プロトコル
 */
protocol PointHistoryModelDelegate {
...
/*
 プロトコル判定用
 */
enum PointHistoryModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}

class PointHistoryModel: NSObject {
    //プロトコル
    var delegate: PointHistoryModelDelegate?;
...
extension PointHistoryModel : ApiRequestDelegate {

...
/*
 プロトコル
 */
protocol GroupEventModelDelegate {
...
/*
 プロトコル判定用
 */
enum GroupEventModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}

class GroupEventModel: NSObject {
    //プロトコル
    var delegate: GroupEventModelDelegate?;
...
extension GroupEventModel : ApiRequestDelegate {

...
/*
 プロトコル
 */
protocol ProfileEditModelDelegate {
...
/*
 プロトコル判定用
 */
enum ProfileEditModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}
...
class ProfileEditModel: NSObject {
    //プロトコル
    var delegate: ProfileEditModelDelegate?;
...
extension ProfileEditModel : ApiRequestDelegate {

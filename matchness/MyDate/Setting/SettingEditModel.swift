...
/*
 プロトコル
 */
protocol SettingEditModelDelegate {
...
/*
 プロトコル判定用
 */
enum SettingEditModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}

class SettingEditModel: NSObject {
    //プロトコル
    var delegate: SettingEditModelDelegate?;
...
extension SettingEditModel : ApiRequestDelegate {

...
/*
 プロトコル
 */
protocol PreferredGroupListModelDelegate {
...
/*
 プロトコル判定用
 */
enum PreferredGroupListModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}

class PreferredGroupListModel: NSObject {
    //プロトコル
    var delegate: PreferredGroupListModelDelegate?;
...
extension PreferredGroupListModel : ApiRequestDelegate {

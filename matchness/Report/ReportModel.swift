...
/*
 プロトコル判定用
 */
enum ReportModelDelegateError : Error {
    case start;
    case complete;
    case failed;
}
...
class ReportModel: NSObject {
    //プロトコル
    var delegate: ReportModelDelegate?;
